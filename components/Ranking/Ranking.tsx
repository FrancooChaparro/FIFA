...
export const Ranking = () => {
  return (
    <div className={styles.containerAll}>
        ...
        <Picture out={true} name={"MANCHESTER CITY"} titles={2} img={"/images/ManchesterCity.png"} rank={3}/>
        <Picture out={true} name={"REAL MADRID"} titles={2} img={"/images/RealMadrid.png"} rank={4}/>
        <Picture out={true} name={"MANCHESTER UNITED"} titles={2} img={"/images/ManchesterUnited.png"} rank={5}/>
        <Picture out={true} name={"ASTON VILLA"} titles={1} img={"/images/AstonVilla.png"} rank={6}/>
        <Picture out={true} name={"TOTTENHAM"} titles={1} img={"/images/Tottenham.png"} rank={7}/>
        <Picture out={true} name={"NAPOLI"} titles={1} img={"/images/SSC_Neapel.svg.png"} rank={8}/>
        <Picture out={true} name={"SEVILLA"} titles={1} img={"/images/Sevilla.webp"} rank={9}/>
        <Picture out={true} name={"VALENCIA"} titles={1} img={"/images/Valencia.jpg"} rank={10}/>
        </div>

        <div className={styles.containerTableYellow}>
        <Picture out={true} name={"INTER"} titles={1} img={"/images/Internazionale.png"} rank={11}/>
        <Picture out={true} name={"PORTO"} titles={1} img={"/images/Porto.jpg"} rank={12}/>
        <Picture out={true} name={"BARCELONA"} titles={1} img={"/images/Barcelona.webp"} rank={13}/>
        <Picture out={true} name={"ARSENAL"} titles={1} img={"/images/Arsenal.jpg"} rank={14}/>
        <Picture out={true} name={"JUVENTUS"} titles={1} img={"/images/Juventus.jpg"} rank={15}/>
        ...
        <Picture out={true} name={"AS ROMA"} titles={0} img={"/images/ASRoma.png"} rank={26}/>
